...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="layout">
			...
			<div id="rightmain">
			   <p>Welcome to visit my homepage.</p>
			   <p>Michael Phelps ROY YANG金牌的背后是巨大的付出!!</p>
<p><?php echo $showtime=date("Y-m-d H:i:s");?></p>
<h2><a href="">800块的淘宝链接杨应龙非常创始的爱着Angela!!!</a></h2>
				<p>today is 7/11 2010</p>
			</div>
			<div class="clear">
			</div>
		</div>
		<div id="footer">
			<div class="friendlink">
				友情链接:　<a href="http://www.lvyaozu.com/" title="耀祖的博客" target="_blank">耀祖的博客</a>　<a href="http://24ear.com" title="小耳朵英语网" target="_blank">小耳朵英语网 胡扯 为发</a>　<span class="frili">下一个链接就和你交换,还等什么,与我联系吧.</span>
			</div>
			<ul>
