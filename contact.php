...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="description" content="Kinglon yang's homepage, 大家有什么问题可以发邮件与我交流." />
		<meta name="keywords" content="Kinglon yang's homepage,English, C language, linux os, network, php, div css, vim, iphone, contact, 联系我, kinglon yang" />
		<meta name="author" content="Kinglon Yang" />
		<meta name="generator" content="VIM7.0" />
		<title>Contact me | 联系我 | 联系Kinglon</title>
	...
	<body>
		...
		<div id="layout">
			...
			<div id="rightmain">
				<ul>
					<li>E-mail: yang286@gmail.com</li>
				</ul>
			</div>
			<div class="clear">
			</div>
