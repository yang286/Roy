...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="keywords" content="Kinglon yang,kinglon,English, C language, linux os, network, php, div css, vim, iphone" />
		<meta name="author" content="Kinglon Yang" />
		<meta name="generator" content="VIM7.0" />
		<title>欢迎访问Kinglon Yang的个人主页</title>
...
iowe Network">
				<li><a href="linux" cmdtitle="Linux OS">Linux OS </a></li>

iowe Network">iowe Network">iowe Network">
...
iowe Network">
				...
				<li><a href="linux" cmdtitle="Linux OS">Linux OS </a></li>
				<li><a asdf="network" cmdtitle="Network">Network </a></li>
				 dlisf ddlisf dlisf sf kl l; iowe goo d morn
				  cmdcmdcmdcmdcmdcmdcmdcmdcmdciowe iowe iowe iowe iowe ioae iowe iowe cmdiowe iowe iowe iowe cmdiowe iowe mdcmdcmd
dlisf dlisf dlisf dlisf dlisf dlisf dlisf 
		...
		<div id="layout">
			<div id="leftmain">
				<ul>
					...
					<li><a href="plan/learnplan.php" title="Learn plan">学习计划</a></li>
					<li><a href="question/thinkques.php" title="Thinking questiones">思考中的问题</a></li>
					<li><a href="question/untiedques.php" title="Untied questiones">已解决的问题</a></li>
					<li><a href="plan/myplan.php" title="My plan">我的计划</a></li>
					<li><a href="otherth/" title="Other thing">其他记事</a></li>
				</ul>
			</div>
		...
		<div id="footer">
			<div class="friendlink">
				友情链接:　<a href="http://www.lvyaozu.com/" title="耀祖的博客" target="_blank">耀祖的博客</a>　<a href="http://24ear.com" title="小耳朵英语网" target="_blank">小耳朵英语网</a>　<span class="frili">下一个链接就和你交换,还等什么,与我联系吧.</span>
			</div>
			<ul>
...
11:03 AM 06/12/2008 Thu 

10:26 PM 06/26/2008 Thu 

04:50 PM 07/18/2008 Fri 
-->
	</body>
</html>
sdfl
