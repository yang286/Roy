...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="description" content="Kinglon yang's homepage,div css,本站的CSS源代码,有兴趣的可以看看,大家共同学习" />
		<meta name="keywords" content="Kinglon yang's homepage,div css,css源码,css source code" />
		<meta name="author" content="Kinglon Yang" />
		<meta name="generator" content="VIM7.0" />
		<title>CSS source code | CSS 源码</title>
	...
	<body>
		...
		<div id="header">
			...
			<ul>
				...
				<li><a href="../javascript" title="JavaScript" id="current"> JavaScript </a></li>
		...
		<div id="layout">
			<div id="leftmain">
				<ul>
					...
					<li><a href="jsnote.php" title="JavaScript 笔记">JavaScript 笔记</a></li>
					<li><a href="jslab.php" title="JavaScript 实验">JavaScript 实验</a></li>
					<li><a href="jsques.php" title="JavaScript 问题">JavaScript 问题</a></li>
					<li><a href="csscode.php" title="Css source code">本站 CSS 源码</a></li>
					<li><a href="xhtml.php" title="xhtml tag">XHTML标签与功能</a></li>
				</ul>
			</div>

			<div id="rightmain">
				<ul>
					<li><a href="../css/main.css.html" title="Look for main.css code" target="_blank">main.css</a></li>
					<li><a href="../css/public.css.html" title="Look for public.css code" target="_blank">public.css</a></li>
				<ul>
