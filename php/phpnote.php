	...
	<body>
		...
		<div id="header">
			...
			<ul>
				...
				<li><a href="../php" title="PHP" id="current">PHP </a></li>
		...
		<div id="layout">
			<div id="leftmain">
				<ul>
					...
					<li><a href="phpnote.php" title="PHP note">PHP 笔记</a></li>
					<li><a href="alongphp.php" title="Get along with PHP">PHP 学习进展</a></li>
					<li><a href="phplab.php" title="PHP lab">PHP 实验</a></li>
					<li><a href="phpques.php" title="PHP questiones">PHP 问题</a></li>
					<li><a href="phppro.php" title="PHP program">PHP 程序</a></li>
				</ul>
			</div>

			<div id="rightmain">
				<p>如果打开phpmyadmin出现如下错误时：Cannot load mysql extension, 只要把php目录中libmysql.dll复制到system32下就可以解决此问题。</p>
			</div>
			<div class="clear">
			</div>
		</div>
