...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="description" content="Kinglon yang's homepage,English, C language, linux os, network, php, div css, vim, iphone" />
		<meta name="keywords" content="Kinglon yang's homepage,English, C language, linux os, network, php, div css, vim, iphone" />
	...
	<body>
		...
		<div id="header">
			...
			<ul>
				...
				<li><a href="" title="English" id="current">English </a></li>
		...
		<div id="layout">
			<div id="leftmain">
				<ul>
					...
					<li><a href="engnote.php" title="Learn English note">英语学习笔记</a></li>
					<li><a href="engalong.php" title="Get along with English">英语学习进展</a></li>
					<li><a href="engques.php" title="English questiones">我的英语问题</a></li>
					<li><a href="engcap.php" title="English capacity">现在的水平</a></li>
					<li><a href="computer.php" title="computer english">计算机专业英语</a></li>
					<li><a href="engres.php" title="English resource">英语资源链接</a></li>
				</ul>
			</div>

			<div id="rightmain">
				<p>I am learning New Concept English 1 (4.24 2008), so my English is very poor now. If your English better than me, you can help me. Send me <a href="#" title="My Email is:yang286@gmail.com" class="black">Email</a> in English, we chat in English, I am waiting for you.</p>
				<p><a href="../otherth/NCEwords.txt">Here is all of the words of New Concept English 1 txt file download. 下载新概念1册所有单词的txt格式。</a></p>
			</div>
			<div class="clear">
			</div>
		</div>
