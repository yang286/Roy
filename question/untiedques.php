...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<meta name="description" content="Kinglon yang's homepage,已解决的问题,我都解决了哪些我已经有的问题,这里有记录" />
		<meta name="keywords" content="Kinglon yang's homepage,解决问题,个人问题解决记录,untied questions" />
		<meta name="author" content="Kinglon Yang" />
		<meta name="generator" content="VIM7.0" />
		<title>Untied questions | 已解决的问题</title>
		...
		<div id="layout">
			<div id="leftmain">
				<ul>
					...
					<li><a href="thinkques.php" title="Thinking questiones">思考中的问题</a></li>
					<li><a href="untiedques.php" title="Untied questiones">已解决的问题</a></li>
			...
			<div id="rightmain">
				<ul>
					<li>此页面正在努力添加中，实在是太忙了，每天的时间都不够用。</li>
				</ul>
			</div>
			<div class="clear">
			</div>
