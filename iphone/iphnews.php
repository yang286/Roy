...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>iphone news | iphone 最新动态</title>
	...
	<body>
		...
		<div id="header">
			...
			<ul>
				...
				<li><a href="../iphone" title="iPhone" id="current">iPhone </a></li>
		...
		<div id="layout">
			<div id="leftmain">
				<ul>
					...
					<li><a href="iphnews.php" title="iphone news">iphone 最新动态</a></li>
					<li><a href="iphunlock.php" title="iphone active unlock">iphone 破解</a></li>
					<li><a href="iphsoft.php" title="iphone software">iphone 软件</a></li>
					<li><a href="iphos.php" title="iphone OS">iphone 系统</a></li>
					<li><a href="iphelite.php" title="iphone elite">iphone 精华转贴</a></li>
				</ul>
			</div>

			<div id="rightmain">
					<p>英国的iphone已经169英镑一台了,不过买时要与当地的一个O2电信公司签18个月的合同才OK,然后每个月要付O2电信20英镑的电话费.<div class="date">4.23 2008</div></p>
			</div>
			<div class="clear">
			</div>
		</div>
