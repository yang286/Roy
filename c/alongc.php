...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Get along with C | C 进展</title>
	...
	<body>
		...
		<div id="header">
			...
			<ul>
				...
				<li><a href="../c" title="C Language" id="current">C Language </a></li>
		...
		<div id="layout">
			<div id="leftmain">
				<ul>
					...
					<li><a href="cnote.php" title="C note">C 笔记</a></li>
					<li><a href="alongc.php" title="Get along with C">C 进展</a></li>
					<li><a href="clab.php" title="C lab">C 实验</a></li>
					<li><a href="cques.php" title="C questiones">C 问题</a></li>
					<li><a href="cpro.php" title="C program">C 程序</a></li>
				</ul>
			</div>
